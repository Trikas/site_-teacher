    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/admin/user_reg')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('lessonwrite')}}" class="nav-link">
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card direct-chat direct-chat-primary">
              <div class="card-header">
                <h3 class="card-title" id="destination">Имя</h3>
              ...
              <div class="card-footer">
                <form action="#" method="post">
                  <div class="input-group">
                    <textarea  name="message" placeholder="Написать сообщение ..." class="form-control" id="type_sms"></textarea>
...
<!-- <script src="{{asset('assets/datausers.js')}}"></script> -->
...
$('#send_sms').on('click', function () {
 $.ajax({
        url: '/admin/ajax',
        cache: false,
        data: {sms: $('#type_sms').val(), destination: $('#destination').html(), _token: '{{csrf_token()}}' },
        type: "POST",
